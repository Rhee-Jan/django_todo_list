...
urlpatterns = [
    ...
    path('deletecont/<cont_id>', todo_views.deletecont, name='deletecont'),
    path('addprofile/', todo_views.addprofile, name='addprofile'),
    path('addcontact/', todo_views.addcontact, name='addcontact')
